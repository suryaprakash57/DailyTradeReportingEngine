...
public class TestIncomingRecordKeeper {
	...
	public void setUp() {
		...
		trade = new TradeMessage(TradeMessage.TRADE, ENTITY, false, "GBP", friday, friday,
				units, price, agreedFx);
		aedTrade = new TradeMessage(TradeMessage.TRADE, ENTITY, false, "AED", saturday, saturday,
				units, price, agreedFx);
	}
